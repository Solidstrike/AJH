...
user_1 = User.create(first_name: 'Addison', last_name: 'Holbrook', email: "Addison@ajhconsulting.net", password: '123456', is_admin: true)
user_2 = User.create(first_name: 'Finance', last_name: 'AJH', email: "Finance@ajhconsulting.net", password: '123456', is_admin: true)
